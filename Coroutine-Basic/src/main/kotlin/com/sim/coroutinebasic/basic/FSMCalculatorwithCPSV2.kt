...
fun main(){
    val completion = Continuation<Int>(EmptyCoroutineContext){
        log.info("FSM Calculator with CPS Result: {}", it)
    }

    FSMCalculatorWithCPSV2.calculate(5, completion)
}
/**
 * 15:30:10:539 [main] - Initial
 * 15:30:10:540 [main] - Add one
 * 15:30:10:540 [main] - Multiply two
 * 15:30:10:540 [main] - FSM Calculator with CPS Result: Success(12)
 */